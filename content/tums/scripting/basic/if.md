---
title: "If Statements"
summary: "How to use if statements in tums"
created: "2026-05-23"
updated: "2026-05-23"
isdoc: true
---
...
- The Statement checks if the [condition](/tums/scripting/basic/expressions) is true, if it is  it will then execute the code after then, if it is false then the Interpreter skips it and goes to `elseif`, `else` or `end`. 
